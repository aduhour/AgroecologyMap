...
![](img/Tuchin2020-redaccioncomar.png){height=4cm}

## Introducción: El mapeo de producciones agroecológicas 

Existen iniciativas de organizaciones sociales e instituciones públicas, en distintos municipios y regiones:

![](img/Intainforma2022.png){height=4cm}

## Introducción: El mapeo de producciones agroecológicas 

Sin embargo, la posibilidad de agregar o modificar información es limitada, y no se encuentran necesariamente en un formato abierto 

<!-- s (Tuchin, 2020; Red Interregional de Nodos Agroecológicos, 2023; Agencia de Extensión Mar del Plata - INTA y col., 2022; Inta Informa 2022). Sin embargo, todas se encuentran basadas en un servicio de mapas privado, la posibilidad de agregar o modificar información es limitada, y su descarga y reutilización no se encuentra necesariamente en un formato abierto. -->

![](img/AgExgINTAMdP2022.png){height=4cm}
...
![](img/IntaInforma.jpg){height=4cm}
...
## Introducción: Presentaciones al Congreso Pronvincial de Agroecología.
...
- Favorecer instancias de construcción de conocimiento, a partir del mapeo de problemas
...
- Si bien existen numerosas etiquetas para describir elementos en OSM, para realizar este proyecto hubiéramos tenido que utlizar etiquetas como "description" o agregar etiquetas a los conjuntos de cambios.
